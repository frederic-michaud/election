...
((i=i+1));
wget https://app-prod-static-voteinfo.s3.eu-central-1.amazonaws.com/v1/ogd/sd-t-17-02-20220925-eidgAbstimmung.json -O ../data/votation_septembre_2022_${i}.json;

  #mettre les données récupérées ci-dessus dans la base de donnée du site
((j=i-1))
echo python manage.py runscript update_scrutin_en_cours --script-args ../data/votation_septembre_2022_${i}.json ../data/votation_septembre_2022_${j}.json
